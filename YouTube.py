...
#API key connection
def Api_connect():
    Api_Id="AIzaSyBJLA0XkoIvN8-El0FNz7IM4_-b46YAYEA"
...
def get_channel_info(channel_id):
    ...
    for i in range(0,len(response1["items"])):
        data = dict(
                    ...
                    Subscriptions= response1["items"][i]["statistics"]["subscriberCount"],
...
#Fied with Prasanna          :"UCv12M4v0ppp3LwA9bd9Rljw"
#Learn with Kabil Mathi      :"UCG8OkRYzTn32Fdhc7xptOeA"
#Naveen Kumar                :"UCE5ywHWaxPWJ9_NSevHaJ-g"
#Mo Draj Travel Shorts       :"UCxlYnwi6NIGERK2cGq4WJ_A"
#TamizharasanRaja            :"UC0c9xcXYGuZBfcP5LOtdOCw"
...
#MongoDB Connection
client = pymongo.MongoClient("mongodb+srv://prakashps16:PrakAvi21@cluster0.izyayqp.mongodb.net/?retryWrites=true&w=majority")
